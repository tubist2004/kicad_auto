...
exports.generateEnumKey = exports.generateEnumName = exports.getAllEnums = void 0;
 ...
 * @returns
 */
function generateEnumKey(name, config) {
    var newKey = SharedTasks.convertCase(name, config.enumKeyCasing);
    // Numeric keys are not allowed and must be converted to a suitable format.
    return isNaN((0, lodash_1.toNumber)(newKey)) ? newKey : config.enumNumericKeyFormat.replace('${key}', newKey);
}
exports.generateEnumKey = generateEnumKey;
