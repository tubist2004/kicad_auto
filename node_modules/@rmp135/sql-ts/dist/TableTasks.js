...
var ColumnTasks = __importStar(require("./ColumnTasks"));
var TableTasks = __importStar(require("./TableTasks"));
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    allTables = (_a.sent())
                        .filter(function (table) { return tables.length == 0 || tables.includes("".concat(table.schema, ".").concat(table.name)); })
                        .filter(function (table) { return !excludedTables.includes("".concat(table.schema, ".").concat(table.name)); });
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 1: return [2 /*return*/, (_a.columns = _b.sent(),
                                            ...
                                            _a.name = table.name,
                                            _a.schema = SchemaTasks.generateSchemaName(table.schema),
...
function getAdditionalProperties(tableName, schemaName, config) {
    var _a;
    var fullName = "".concat(schemaName, ".").concat(tableName);
