...
exports.generateDatabase = exports.stringifyDatabase = void 0;
...
function stringifyDatabase(database, config) {
    ...
    var compiler = Handlebars.compile(templateString, { noEscape: true });
    ...
    Handlebars.registerHelper('handleNumeric', function (aString) {
        return (0, lodash_1.isNumber)(aString) ? aString : new Handlebars.SafeString("'".concat(aString, "'"));
    });
    database.tables.sort(function (tableA, tableB) { return tableA.name.localeCompare(tableB.name); });
    database.enums.sort(function (enumA, enumB) { return enumB.name.localeCompare(enumA.name); });
    var template = {};
 ...
 */
function generateDatabase(config, db) {
